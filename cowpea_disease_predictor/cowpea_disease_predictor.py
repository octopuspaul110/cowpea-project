...
model_filepath = "/content/drive/MyDrive/agric_proj/models/disease_predictor_model.joblib"
encoder_filepath = "/content/drive/MyDrive/agric_proj/models/one_hot_encoder.pkl"
